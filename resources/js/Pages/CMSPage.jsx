        ...
        <AppLayout>
            ...
            <div className="pb-32">
                ...
                <div className="bg-slate-900 pt-20 pb-32 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-600 opacity-10 blur-[120px] rounded-full -mr-32 -mt-32"></div>
                    ...
                    <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-4xl">
                        <nav className="flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 mb-8">
                            ...
                            <span className="text-blue-500">{page.title}</span>
                        </nav>
                    ...
                    <div className="bg-white rounded-[3rem] p-12 md:p-20 shadow-2xl shadow-slate-200 border border-slate-50">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
                            ...
                            <div className="lg:col-span-4 space-y-12">
                                <div className="p-10 bg-blue-600 rounded-[2.5rem] text-white shadow-xl shadow-blue-200 relative overflow-hidden group">
                                    ...
                                    <p className="text-blue-100 font-medium mb-8 relative z-10 opacity-80">Our support team is ready to assist you with any inquiries about our services or policies.</p>
                                    <Link href="#" className="inline-flex items-center gap-3 bg-white text-blue-600 px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg hover:bg-slate-50 transition-all active:scale-95 relative z-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex gap-4 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 group hover:border-blue-100 hover:bg-white transition-all">
                                            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-blue-600 shadow-sm shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all">
                                                <item.icon size={20} />
                                            </div>
                                            <div>
                ...
                {services?.length > 0 && (
                    <div className="container mx-auto px-4 md:px-6 pt-32 text-center">
                        <span className="text-blue-600 text-[10px] font-black uppercase tracking-[0.3em] mb-4 block">What We Offer</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            {services.map((service, i) => {
                                ...
                                <div key={i} className="group flex flex-col items-center">
                                    <div className="w-40 h-40 bg-slate-100 rounded-[3rem] overflow-hidden mb-8 relative flex items-center justify-center p-8 group-hover:bg-blue-600 transition-all duration-700 shadow-inner group-hover:shadow-blue-200">
                                        <IconComponent className="w-16 h-16 text-slate-300 group-hover:text-white transition-all duration-500" strokeWidth={1.5} />
                                    </div>
                                    <h3 className="text-2xl font-black text-slate-800 mb-4 group-hover:text-blue-600 transition-colors tracking-tight">{service.title || service.name}</h3>
