                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-1">
                                ...
                                <span className={cn(
                                    ...
                                    order.order_status === 'delivered' ? "bg-emerald-500/10 text-emerald-600" : "bg-blue-500/10 text-blue-600"
                                )}>
                                    {order.order_status}
                                </span>
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                            ...
                            <div className="relative">
                                <div className="flex justify-between items-center mb-10">
                                    <h3 className="text-xl font-black text-slate-800 tracking-tight flex items-center gap-3">
                                        <ShoppingBag size={20} className="text-blue-600" /> Cart Contents
                                    </h3>
                                    <Link 
                                    ...
                                    {order.items?.map((item) => (
                                        <div key={item.id} className="flex gap-6 items-center">
                                            <div className="w-24 h-24 bg-slate-50 rounded-3xl overflow-hidden shadow-inner border border-slate-100 shrink-0">
                                                <img 
                                                    src={item.product?.thumbnail ? (item.product.thumbnail.startsWith('http') ? item.product.thumbnail : `/storage/${item.product.thumbnail.replace(/^\//, '')}`) : '/placeholder-product.jpg'} 
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <Link 
                                                    ...
                                                    className="font-black text-slate-800 text-lg hover:text-blue-600 transition-colors block truncate"
                                                >
                                ...
                                <div className="mt-12 pt-10 border-t border-slate-50 space-y-4">
                                    ...
                                    <div className="flex justify-between items-center pt-6 px-2">
                                        ...
                                        <div className="text-right">
                                            <p className="text-4xl font-black text-blue-600 tracking-tighter">৳{parseFloat(order.total).toLocaleString()}</p>
                                            <p className={cn(
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <section className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-sm">
                                ...
                                <textarea 
                                    className="w-full bg-slate-50 border-none rounded-3xl p-6 text-sm font-bold min-h-[120px] focus:ring-2 focus:ring-blue-100 transition-all placeholder:text-slate-300 mb-4"
                    ...
                    <div className="space-y-12">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-10 relative overflow-hidden text-white shadow-2xl">
                            <div className="absolute top-0 right-0 w-48 h-48 bg-blue-600 opacity-20 blur-[60px] rounded-full -mr-24 -mt-24"></div>
                            <div className="relative">
                                ...
                                <div className="space-y-6">
                                    ...
                                    >
                                        <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center border border-white/10 group-hover:bg-blue-600 transition-all shrink-0">
                                            <Phone size={18} />
                                        </div>
                                    ...
                                    <button className="w-full py-4 bg-white/5 border border-white/10 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all flex items-center justify-center gap-2 group">
                                        <MessageSquare size={14} className="text-blue-400 group-hover:scale-110 transition-transform" /> Send Strategic SMS
                                    </button>
                                    {order.user?.is_vip && (
                        ...
                        <section className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-sm">
                            ...
                            <div className="space-y-6">
                                ...
                                <select 
                                    className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-xs font-black uppercase tracking-widest focus:ring-2 focus:ring-blue-100 appearance-none cursor-pointer"
