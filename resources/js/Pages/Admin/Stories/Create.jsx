...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        title: '',
        subtitle: 'MADE IN BANGLADESH',
        description: '',
        points: ['', '', ''],
        image: null,
        button_text: 'আমাদের গল্প পড়ুন',
        button_url: '/page/about-us',
        status: true,
        sort_order: 0,
    });
                ...
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-black text-slate-800 tracking-tight">Add New Story</h1>
                                <p className="text-slate-500 font-bold">Add a new artisan story in the homepage slider.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                placeholder="আসলে বাংলাদেশের গল্প"
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                placeholder="MADE IN BANGLADESH"
                                                className="w-full bg-slate-50 border-none px-6 py-4 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-emerald-100 transition-all font-sans"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="আমাদের প্রতিটি পণ্য শুধু একটি ব্যবহারের বস্তু নয়..."
                                        ...
                                        {data.image ? (
                                            <>
                                                ...
                                                <button
                                                    ...
                                                    className="absolute inset-0 bg-black/40 text-white opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 font-black uppercase text-xs tracking-widest"
                                                >
                                                    <Trash2 size={18} /> Change Image
                                                </button>
                                            </>
                                        ) : (
                                            <label className="cursor-pointer flex flex-col items-center gap-4 text-slate-300 group-hover:text-indigo-400 transition-colors">
                                                <ImageIcon size={64} />
                                                <span className="font-black text-xs uppercase tracking-widest text-center">Click to upload story image</span>
                        ...
                        <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50">
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-emerald-600/20 transition-all flex items-center gap-2"
                                >
                                    {processing ? <Loader2 className="animate-spin" size={16} /> : <><Save size={16} /> Save artisan story</>}
                                </button>
                            </motion.div>
                        </div>
                    </form>
