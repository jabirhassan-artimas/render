...
export default function Create() {
    ...
    return (
        <AdminLayout>
            <Head title="Client Voice Adoption" />
            ...
            <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-slate-800 tracking-tight">New Social Proof</h1>
                        <p className="text-slate-500 text-sm font-medium">Record a new client testimonial or success story.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-slate-50 border-none px-6 py-4 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-blue-100 transition-all font-sans"
                                    placeholder="e.g. CEO, Global Solutions"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <label className="flex items-center gap-2 text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">
                                <MessageSquare size={12} /> Reflection / Quote
                            </label>
                            <textarea 
                                value={data.content}
                                ...
                                placeholder="What did the client say about your platform?"
                            ></textarea>
                        ...
                        <div className="pt-6 border-t border-slate-50">
                            <label className="flex items-center gap-4 cursor-pointer group">
                                ...
                                <div>
                                    <p className="text-xs font-black text-slate-800 uppercase tracking-tight">Public Display</p>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Show this review on the homepage tracker</p>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-3 pb-10">
                        ...
                        >
                            <Save size={18} /> {processing ? '...' : 'Deploy Voice'}
                        </button>
                    </div>
                </form>
            </div>
